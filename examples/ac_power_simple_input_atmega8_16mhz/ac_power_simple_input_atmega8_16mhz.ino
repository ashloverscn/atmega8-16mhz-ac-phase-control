...
//atmega8_16mhz_ac_phase_control.uninit();
}

void loop() {
  for(int i=1;i<623;i++)
  {
   atmega8_16mhz_ac_phase_control.set_ac_power(i);//speed[0 to 13] or 623 to 1 
   delay(800);
  }
  ...
  /*
   for(int i=0;i<=13;i++)
  {
   atmega8_16mhz_ac_phase_control.set_ac_power(speed[i]);//speed[0 to 13] or 623 to 1 
   delay(1000);
  }
